...
return (
    <div className="mx-auto max-w-4xl mb-8 px-4">
                <Link to="/search">
                    <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-500 to-blue-300 rounded-2xl p-6 shadow-2xl
  hover:shadow-blue-500/50 transition-all duration-300 cursor-pointer group">
  ...
  duration-500"></div>
                        <div className="relative z-10">
                            <div className="flex items-center justify-center gap-3 mb-2">
                                <span className="px-3 py-1 text-xs font-bold text-blue-600 bg-white rounded-lg animate-pulse">
                                    NEW
                                </span>
